...
schema_view = get_schema_view(
    openapi.Info(
        ...
        default_version="v1",
        description="API endpoints for Book Breeze API Course",
...
admin.site.site_header = "Book Breeze API Admin"

admin.site.site_title = "Book Breeze API Admin Portal"

admin.site.index_title = "Welcome to Book Breeze API Portal"
